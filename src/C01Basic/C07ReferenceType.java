...
//        String은 예외적으로 리터럴 값  세팅 허용
//        String st2="hello world";
//        참조자료형을 출력하면 힙메모리의 주소값이 출력되어야하나, String내부에 toStrong메서드가 구현 및 자동호출 되도록 설계
//        System.out.println(st1);

//        int[] arr1=new int[4];
//        배열도 객체이므로 new키워드를 써야 하나, 예외적으로 리터럴값 세팅 허용
//        int[] arr2={1,3,5,7};
//        배열은 toString 메서드가 별도로 구현되어 있기 떄문에 별도로 호출해줘여함
...
//        참조자료형은 스택메모리에 힙메모리의 주소값이 저장되므로 ==로 비교시 메모리값주소를 비교
//        String st1=new String("hello");
//        String st2=new String("hello");
//        System.out.println(st1==st2);
//        별도의 메서드를 통해 힙 메모리의 값을 비교
...
//        추후 배우게 될 list, map, set등 참조자료형에는 원시자료형을 쓸 수 없음
