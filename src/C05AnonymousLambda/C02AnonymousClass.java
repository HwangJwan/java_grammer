...
//        인터페이스의 익명객체에 구현해야할 메서드가 한 개 밖에 없을때는 람다 표현식(화살표함수)사용가능
//        Animal2 a2_1=() ->{
...
//        실습 - Animal4인터페이스 생성 및 makeSound 선언 : 매개변수는 String, String, int, 리턴타입은 String
