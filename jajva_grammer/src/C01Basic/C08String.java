...
//        .equals : 힙메모리의 문자열을 가져와서 equal관계 비교
//        String st1="hello1";
//        String st2="Hello1";
...
//
//        toUpperCase : 모든 문자열 대문자로 변환, toLowerCase : 소문자로 변환
//        String st1="Hello";
...
//            sb.append(" ");     //\n은 줄바꿈 의미
//        }
//        sb.insert(0,"C++"); // 문자열 중간에 insert하는 것은 성능저하 발생
//        sb.deleteCharAt(0);     // 마지막 index를 삭제하는 것 외에는 사용X
//        result=sb.toString();
//        System.out.println(result);

//       StringBuilder는 성능이 뛰어나지만, 동시성 문제 있음(Thread-Safe하지 않음)
//        예를 들어)쓰레드 A가 append("hello") 쓰레드 B가 append("world")
//        이 두작업이 중간에 섞여 "heworllo"이런식으로 잘못된 값을 만들수 있음
//        StringBuilder sb2=new StringBuilder();
////        문자열 뒤집기
//        String st1="hello";
//        sb2.append(st1).reverse();
...
//        문자열비교
        ...
        System.out.println(st1.compareTo(st2)); //앵수
