...
//            arr[i]+=10;
//        }
//        참조형 변수(객체 타입)은 기본적으로 변수를 통한 출력시에 메모리값이 출력
//        그래서 내장된 메서드를 통해 힙메모리 안의 객체값을 보기좋게 출력할 수 있음
//        스택 : 기본형 변수, 참조형 변수의 힙 메모리 주소값
//        힙 : 참조형 변수값
...
//            int num2=30;
//        }
//        하위 영역에서 정의된 변수는 상위 블록에서는 접근 불가
//        for(int i=0;i<10;i++) {
...
//        3단입니다. 를 먼저 출력후에 3X1=2 3X2=6 3X3=9 ...
        for(int i=2;i<10;i++) {
